...
class _HomeScreenState extends State<HomeScreen> {
            ...
            children: [
              ...
              ...List.generate(sections.length, (index) {
                ...
                return Column(
                  ...
                  children: [
                    header(section["title"], h, w),
                    SizedBox(height: h * 0.015),
                    cardRow(section["data"], context, h, w),
  ...
  Widget cardRow(List<Map<String, dynamic>>data ,BuildContext context,var h , var w) {
    return SingleChildScrollView(
      scrollDirection: Axis.horizontal,
      child: Padding(
      ...
      children: [
        Stack(
          children: [
            /// FIRST IMAGE
            Container(
              width: w * 0.39,  // 137 → responsive
              height: h * 0.25, // 200 → responsive
            ...
            if (showTopIcon)
              Positioned(
                ...
                child: Container(
                  width: w * 0.065,  // 24 → responsive
                  height: w * 0.065, // keep circle
                  decoration: BoxDecoration(
                  ...
                  child: Center(
                    child: SizedBox(
                      width: w * 0.038,  // 14 → responsive
                      height: w * 0.038, // keep square
                      child: (type == 'image')
            ...
            Positioned(
              ...
              child: Center(
                child: Text(
                  ...
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: w * 0.033, // 12 → responsive
                    fontFamily: 'Inter',
                    fontWeight: FontWeight.w600,
                  ),
                ),
    ...
    return InkWell(
      ...
      child: Container(
        width: double.infinity,
          height: h * 0.23,
          child: Image.asset('assets/images/engagement.png')),
    );
  }

  Widget header(String s,var h,var w)
  {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 12),
      child: Row(
  ...
  PreferredSizeWidget CustomAppBar(double h, double w) {
    return PreferredSize(
      preferredSize: Size.fromHeight(h * 0.11),
      child: Container(
        width: w,
